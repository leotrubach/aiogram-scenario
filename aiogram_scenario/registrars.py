...
def _log_registration_handler_on_state(callback: Callable, handler_type: str, state: AbstractState) -> None:

    logger.debug(f"Handler '{callback.__qualname__}' (type='{handler_type}') is registered on state: '{state}'!")


def _log_registration_handler(callback: Callable, handler_type: str) -> None:
...
class Registrar:
    ...
    def register_callback_query_handler(self, callback: Callable,
        ...
        self._dispatcher.register_callback_query_handler(callback, *custom_filters, state=self._state.raw_value,
                                                         run_task=run_task, **kwargs)
        _log_registration_handler_on_state(callback, "callback_query", self._state)

    def register_channel_post_handler(self, callback: Callable,
                                      *custom_filters,
                                      commands=None,
                                      regexp=None,
                                      content_types=None,
    ...
    def register_chosen_inline_handler(self, callback: Callable,
                                       *custom_filters,
                                       run_task=None,
                                       **kwargs) -> None:
    ...
    def register_edited_message_handler(self, callback: Callable,
                                        *custom_filters,
                                        commands=None,
                                        regexp=None,
                                        content_types=None,
    ...
    def register_inline_handler(self, callback: Callable,
                                *custom_filters,
                                run_task=None,
                                **kwargs) -> None:
...
class MainRegistrar:
    ...
    def register_fsm_handlers(self, states: Collection[AbstractState],
                              **reg_kwargs) -> None:
    ...
    def register_error_handler(self, callback: Callable,
                               *custom_filters,
                               exception=None,
                               run_task=None,
                               **kwargs) -> None:
