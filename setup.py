...
def fetch_version() -> str:
    ...
    content = (Path(__file__).parent / "aiogramscenario" / "__init__.py").read_text(encoding="UTF-8")
    try:
...
setuptools.setup(
    ...
    description="Scene-based FSM implementation for Telegram bots on aiogram.",
